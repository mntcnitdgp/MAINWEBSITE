    ...
    <>
      <div className={styles.FooterSocial}>
        <a
          ...
          target="_blank"
        >
          <span className={styles.FooterSocialLinksIcon}>
            <FeatherIcon icon="facebook" size="20" stroke="none" />
          </span>
          @mathsntechclub
        </a>
        ...
        >
          <span className={styles.FooterSocialLinksIcon}>
            <FeatherIcon icon="instagram" size="20" stroke="none" />
          </span>
          @mntc.nitd
        </a>
        ...
        >
          <span className={styles.FooterSocialLinksIcon}>
            <FeatherIcon icon="linkedin" size="20" stroke="none" />
          </span>
        ...
        >
          <span className={styles.FooterSocialLinksIcon}>
            <FeatherIcon icon="mail" size="20" stroke="none" />
          </span>
          mathsntechclub@gmail.com
        </a>
      </div>
      ...
      <div className={styles.FooterInfo}>
        ...
        >
          <span className={styles.FooterSocialLinksIcon}>
            <FeatherIcon icon="phone" size="20" stroke="none" />
          </span>
          +91-89060-51932
        </a>
      </div>
...
const Footer = () => {
  return (
    <footer className={styles.Footer}>
      <div className={`${styles.FooterContainerMobile} container`}>
        {<FooterMobile />}
      </div>
      <div className={`${styles.FooterContainerDesktop} container`}>
        {<FooterDesktop />}
      </div>
    </footer>
  );
